...
class AppColors {
  ...
  static const Color champagneGold = Color(0xFFF59E0B);
  static const Color cardLuxury = Color(0xFF1E293B);
  static const Color cardGlass = Color(0x1AFFFFFF);
  static const Color borderGlass = Color(0x33F59E0B);
  static const Color borderGold10 = Color(0x1AF59E0B);
